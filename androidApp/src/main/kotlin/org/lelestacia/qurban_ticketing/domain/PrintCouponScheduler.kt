        ...
        val workRequest = OneTimeWorkRequestBuilder<PrintCouponWorker>()
            .setInputData(
                Data.Builder()
                    ...
                    .putInt(PrintCouponWorker.START_HOUR, input[2] as Int)
                    .putInt(PrintCouponWorker.START_MINUTE, input[3] as Int)
                    .putInt(PrintCouponWorker.FINISH_HOUR, input[4] as Int)
                    .putInt(PrintCouponWorker.FINISH_MINUTE, input[5] as Int)
                    .build()
            )
            .build()
