...
import qurbanticketing.composeapp.generated.resources.notification_body_export_data
...
class ExportDataWorker(
    ...
    private suspend fun postNotification() {
        val notificationBuilder = NotificationCompat.Builder(applicationContext, "default_channel")
            ...
            .setContentText(
                getString(
                    resource = Res.string.notification_body_export_data
                )
            )
            .setPriority(NotificationCompat.PRIORITY_DEFAULT)
            .setAutoCancel(true)
